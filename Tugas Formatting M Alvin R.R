# Title       : Tugas Formating M. Alvin R.
# Date        : August 28, 2019
# Author      : Muhammad Alvin Rezani
# Description : This is my task about formating Online_Retail dataset from https://archive.ics.uci.edu/ml/datasets/online+retail
...
# Preview of the first 6 rows and the last 6 rows of data
...
# Now we are going to make a new table :
